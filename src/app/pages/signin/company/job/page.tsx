  ...
  return (
    ...
    <div className='w-full flex justify-center mt-[50px] max-sm:mt-[10px] '>
        <div className='w-[440px] flex flex-col gap-6 p-3'>
              ...
              <h1 className='text-3xl text-[#202192]'>Add profile information</h1>
            ...
            <button type='submit' className='border border-[#202192] py-2 w-full rounded-md bg-[#202192] text-white' onClick={()=> {handleSubmit(idUser)}}>continue</button>
    </div>
