                ...
                <form className="flex w-[70%] flex-wrap flex-col">
                    ...
                    <div className="flex justify-between my-[2.5vh] h-[8vh]"> {/* ชื่อบริษัท */}
                        <div className="flex flex-col w-[40%]"> {/* ชื่อบริษัท */}
                            ...
                            <input type="text" name="company_name"  id="company_name" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md" onChange={onChange} required />
                        </div>
                        <div className="flex flex-col w-[40%]"> {/* ชื่อบริษัท */}
                            <label className="text-[1rem]">เลขผู้เสียภาษี</label>
                            <input type="text" name="tax_payer"  id="tay_payer" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md" onChange={onChange} required />
                        </div>
                    </div>
                    ...
                    <div className="flex my-[2.5vh] h-[8vh]"> {/* ลิงก์บริษัท */}
                        <div className="flex flex-col"> {/* ลิงก์บริษัท */}
                            ...
                            <input type="url" name="company_links" id="company_links" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md" onChange={onChange}/>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col my-[2.5vh]"> {/* ที่อยู่ */}
                        ...
                        <div className="flex justify-between my-[2.5vh] h-[8vh]"> {/* บ้านเลขที่/หมู่ / ซอย */}
                            <div className="flex flex-col w-[40%]"> {/* บ้านเลขที่/หมู่ */}
                                ...
                                <input type="text" name="address_number" id="address_number" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md" onChange={onChange} required/>
                            </div>

                            <div className="flex flex-col w-[40%]"> {/* ซอย */}
                                <label className="text-[1rem]">ซอย </label>
                                <input type="text" name="alley" id="alley" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md" onChange={onChange}/>
                            </div>
                        </div>
                        <div className="flex justify-between my-[2.5vh] h-[8vh]"> {/* แยก / ถนน */}
                            <div className="flex flex-col w-[40%]"> {/* แยก */}
                                ...
                                <input type="text" name="lane" id="lane" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md" onChange={onChange}/>
                            </div>

                            <div className="flex flex-col w-[40%]"> {/* ถนน */}
                                <label className="text-[1rem]">ถนน </label>
                                <input type="text" name="road" id="road" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md" onChange={onChange} required/>
                            </div>
                        </div>
                        <div className="flex justify-between my-[2.5vh] h-[8vh]"> {/* แขวง/อำเภอ / เขต/ตำบล */}
                            <div className="flex flex-col w-[40%]"> {/* แขวง/อำเภอ */}
                                ...
                                <input type="text" name="khwaeng" id="khwaeng" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md" onChange={onChange} required/>
                            </div>

                            <div className="flex flex-col w-[40%]"> {/* เขต/ตำบล */}
                                <label className="text-[1rem]">เขต/ตำบล</label>
                                <input type="text" name="district" id="district" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md" onChange={onChange} required/>
                            </div>
                        </div>
                        <div className="flex justify-between my-[2.5vh] h-[8vh]"> {/* จังหวัด / รหัสไปรษณีย์ */}
                            <div className="flex flex-col w-[40%]"> {/* จังหวัด */}
                                ...
                                <input type="text" name="province" id="province" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md" onChange={onChange} required/>
                            </div>
                            <div className="flex flex-col w-[40%]"> {/* รหัสไปรษณีย์ */}
                                <label className="text-[1rem]">รหัสไปรษณีย์</label>
                                <input type="text" name="mail_address" id="mail_address" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md" onChange={onChange} required/>
                            </div>
                        </div>
                    </div>
