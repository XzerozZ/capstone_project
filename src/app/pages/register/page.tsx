                    ...
                    <form className="flex w-[50%] flex-wrap flex-col" onSubmit={onSubmit}> {/* Forms Box */}
                        <div className="flex justify-between my-[2.5vh] h-[8vh]"> {/* Name / Lastname box */}
                            <div className="flex flex-col w-[40%]"> {/* Name box */}
                                ...
                                <input type="text" name="name" id="name" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md"onChange={onChange}value={regData.name} required />
                            </div>
                            <div className="flex flex-col w-[40%]"> {/* Lastame box */}
                                <label className="text-[1rem]">Last name</label>
                                <input type="text" name="lastname" id="lastname" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md"onChange={onChange}value={regData.lastname} required />
                            </div>
                        </div>
                        <div className="flex justify-between my-[2.5vh] h-[8vh]"> {/* Display name(Username) / Email box */}
                            <div className="flex flex-col w-[40%]"> {/* Display name(Username) box */}
                                ...
                                <input type="text" name="username" id="username" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md"onChange={onChange}value={regData.username} required />
                            </div>
                            <div className="flex flex-col w-[40%]"> {/* Email box */}
                                <label className="text-[1rem]">Email</label>
                                <input type="email" name="email" id="email" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md"onChange={onChange}value={regData.email} required />
                            </div>
                        </div>
                        <div className="flex justify-between my-[2.5vh] h-[8vh]"> {/* Password box */}
                            <div className="w-full flex flex-col">
                                <label className="text-[1rem]">Password</label>
                                <input type="password" name="password" id="password" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md"onChange={onChange}value={regData.password} required/>
                            </div>
                        </div>
                        <div className="flex justify-between my-[2.5vh] h-[8vh]"> {/* Confirmed password box */}
                            <div className="w-full flex flex-col">
                                ...
                                <input type="password" name="confirmedPassword" id="confirmedPassword" className="border-solid border-[#E2E1E5] border-2 h-full rounded-md"onChange={onChange}value={regData.confirmedPassword} required/>
                            </div>
                        </div>
                        <div className="flex mt-[2.5vh] mb-[4vh] h-[8vh]"> {/* Role box */}
                            <div className="flex flex-col w-[40%]">
                                <label className="text-[1rem]">Role</label>
                                <select name="role" id="role"className="border-solid border-[#E2E1E5] border-2 h-full rounded-md"onChange={onChange} value={regData.role} required>
