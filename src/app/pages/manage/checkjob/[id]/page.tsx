...
const page = (props: Props) => {
  ...
  const handleSendWork = (email:any,job_id:any) => {
    try {
      const formData = new FormData()
      formData.append('email', email);
...
<button className='px-4 py-2 bg-[#202192] text-2xl text-white rounded-lg w-full' onClick={() => handleSendWork(email,params.id)}>ส่งงาน</button>
</div>
</div> 
}
      </div>
